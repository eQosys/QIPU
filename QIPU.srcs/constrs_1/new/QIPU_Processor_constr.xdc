...
# SLIDE SWITCHES
set_property -dict { PACKAGE_PIN R2  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[15] }]
set_property -dict { PACKAGE_PIN T1  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[14] }]
set_property -dict { PACKAGE_PIN U1  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[13] }]
set_property -dict { PACKAGE_PIN W2  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[12] }]
set_property -dict { PACKAGE_PIN R3  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[11] }]
set_property -dict { PACKAGE_PIN T2  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[10] }]
set_property -dict { PACKAGE_PIN T3  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[9] }]
set_property -dict { PACKAGE_PIN V2  IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[8] }]
set_property -dict { PACKAGE_PIN W13 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[7] }]
set_property -dict { PACKAGE_PIN W14 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[6] }]
set_property -dict { PACKAGE_PIN V15 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[5] }]
set_property -dict { PACKAGE_PIN W15 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[4] }]
set_property -dict { PACKAGE_PIN W17 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[3] }]
set_property -dict { PACKAGE_PIN W16 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[2] }]
set_property -dict { PACKAGE_PIN V16 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[1] }]
set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 } [get_ports { hw_slide_switches_i[0] }]
...
# DPAD BUTTONS
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { hw_dpad_btns_i[0] }]
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports { hw_dpad_btns_i[1] }]
set_property -dict { PACKAGE_PIN T17 IOSTANDARD LVCMOS33 } [get_ports { hw_dpad_btns_i[2] }]
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports { hw_dpad_btns_i[3] }]
set_property -dict { PACKAGE_PIN W19 IOSTANDARD LVCMOS33 } [get_ports { hw_dpad_btns_i[4] }]
