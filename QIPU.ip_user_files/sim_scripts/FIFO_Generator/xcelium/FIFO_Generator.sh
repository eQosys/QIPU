...
#
# Script generated by Vivado on Mon Oct 30 21:19:24 CET 2023
...
#
# Usage        : FIFO_Generator.sh
#                FIFO_Generator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIFO_Generator.sh [-reset_run]
#                FIFO_Generator.sh [-reset_log]
#                FIFO_Generator.sh [-help]
#
...
#                script (type 'FIFO_Generator.sh -help' for more information).
#
...
# script info
echo -e "FIFO_Generator.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIFO_Generator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.FIFO_Generator xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.FIFO_Generator -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log FIFO_Generator_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: FIFO_Generator.sh [-step]\n\
Usage: FIFO_Generator.sh [-lib_map_path]\n\
Usage: FIFO_Generator.sh [-reset_run]\n\
Usage: FIFO_Generator.sh [-reset_log]\n\
Usage: FIFO_Generator.sh [-keep_index]\n\
