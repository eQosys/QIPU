...
#
# Script generated by Vivado on Sun Aug 27 01:21:19 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Primary_Clock.sh
...
#
# Usage        : Primary_Clock.sh
#                Primary_Clock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Primary_Clock.sh [-reset_run]
#                Primary_Clock.sh [-reset_log]
#                Primary_Clock.sh [-help]
#
...
#                script (type 'Primary_Clock.sh -help' for more information).
#
...
# script info
echo -e "Primary_Clock.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Primary_Clock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Primary_Clock xil_defaultlib.glbl -o Primary_Clock_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Primary_Clock_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tecstylos/dev/QIPU/QIPU.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Primary_Clock_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Primary_Clock_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Primary_Clock.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Primary_Clock.sh [-help]\n\
Usage: Primary_Clock.sh [-step]\n\
Usage: Primary_Clock.sh [-lib_map_path]\n\
Usage: Primary_Clock.sh [-reset_run]\n\
Usage: Primary_Clock.sh [-reset_log]\n\
Usage: Primary_Clock.sh [-keep_index]\n\
Usage: Primary_Clock.sh [-noclean_files]\n\n\
