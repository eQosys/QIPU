...
#
# Script generated by Vivado on Sat Oct 28 03:40:57 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Clock_Manager.sh
...
#
# Usage        : Clock_Manager.sh
#                Clock_Manager.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Clock_Manager.sh [-reset_run]
#                Clock_Manager.sh [-reset_log]
#                Clock_Manager.sh [-help]
#
...
#                script (type 'Clock_Manager.sh -help' for more information).
#
...
# script info
echo -e "Clock_Manager.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Clock_Manager.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Clock_Manager xil_defaultlib.glbl -o Clock_Manager_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Clock_Manager_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Clock_Manager_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Clock_Manager_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Clock_Manager.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Clock_Manager.sh [-help]\n\
Usage: Clock_Manager.sh [-step]\n\
Usage: Clock_Manager.sh [-lib_map_path]\n\
Usage: Clock_Manager.sh [-reset_run]\n\
Usage: Clock_Manager.sh [-reset_log]\n\
Usage: Clock_Manager.sh [-keep_index]\n\
Usage: Clock_Manager.sh [-noclean_files]\n\n\
